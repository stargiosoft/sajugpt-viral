...
const PHASE2_REACTIONS = {
  listen: '윤태산: 야, 이놈아! 네가 지난번에 마마 앞에서 발이 떨리던 거 잊었냐?\n\n서휘윤: 윤태산, 네 주먹보다 내 혀가 마마를 더 잘 모신다. 너도 알잖아.\n\n도해결: 두 분... 마마께서 듣고 계실 수도 있습니다만... 아, 아닙니다. 저도 할 말은 있습니다.',
  cough: '윤태산: ...! 마, 마마?! 아닙니다, 저희는 그냥... 업무 회의를...\n\n서휘윤: (책을 뒤집어 들며) 시, 시를 읽고 있었습니다...\n\n도해결: (즉시 무릎) 마마, 얼마나 들으셨습니까... 모든 것은 마마를 위한 것이었습니다.',
  interrupt: '윤태산: (즉시 무릎) 명하십시오, 마마. 목숨을 걸겠습니다.\n\n서휘윤: (붓을 놓으며) 마마의 한 마디가 저의 만 마디보다 무겁습니다.\n\n도해결: (이마가 바닥에 닿을 때까지) 불찰을 용서하십시오. 무엇이든 분부하십시오.',
};
...
const FALLBACK_RESULT: GeminiResult = {
  phase1: `윤태산: 이 평가표... 제가 아니면 감당 못 합니다. 서휘윤, 네 시 따위로 마마를 어찌하겠다는 거냐.\n\n서휘윤: 무식한 놈. 마마는 세밀하게 다뤄야 해. 네 식으로 덤벼들면 마마가 재미없어서 하품하실 거다.\n\n도해결: 두 분 다 틀렸습니다. 천천히, 정성껏, 한 겹씩 벗겨드려야 합니다. 기다림이 최고의 시중입니다.\n\n윤태산: 마마는 기다림 따위 원하시지 않아. 밤새 버틸 수 있는 건 나뿐이다.\n\n서휘윤: ...솔직히 그건 나도 좀 무섭다.\n\n도해결: 저는 마마께서 원하시면 무릎이 닳도록이라도...`,
...
[시종 캐릭터]
윤태산(야수형): 직설적, 거침없음, 본능적. "말이 필요합니까?"가 입버릇. 다른 시종을 무시하고 자신이 최적이라고 주장.
서휘윤(시인형): 감성적, 비유와 은유 사용, 느리지만 깊음. 윤태산를 "무식하다"고 깔봄. 서사적 시중이 최고라 주장.
도해결(집사형): 절제된 매너, 존댓말, 헌신과 순종. "마마의 편안함이 최우선"이 신념. 다른 둘의 싸움을 중재하다가 자기 어필.
...
{"phase1":"윤태산: \\"대사\\"\\n\\n서휘윤: \\"대사\\"\\n\\n도해결: \\"대사\\"\\n\\n윤태산: \\"대사\\"\\n\\n서휘윤: \\"대사\\"\\n\\n도해결: \\"대사\\"","phase3_beast":"윤태산의 최종 제안 3~4문장","phase3_poet":"서휘윤의 최종 제안 3~4문장","phase3_butler":"도해결의 최종 제안 3~4문장"}

2. Phase 1 (엿듣기 토론):
   - 6턴 (윤태산→서휘윤→도해결→윤태산→서휘윤→도해결 순환)
