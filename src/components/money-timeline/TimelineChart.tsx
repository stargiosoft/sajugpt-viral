...
import type { WealthPeriod, BestPeriodInfo } from '@/types/money-timeline';
...
export default function TimelineChart({ periods }: Props) {
...
export function GoldenEraCard({ bestPeriod }: { bestPeriod: BestPeriodInfo }) {
  ...
  return (
    <div style={{ padding: '20px 0' }}>
      ...
      <div className="flex flex-col" style={{ gap: '8px' }}>
        {bestPeriod.features.map((feature, i) => (
          <div key={i} style={{ borderRadius: '14px', backgroundColor: 'rgb(246, 245, 255)', padding: '16px 18px' }}>
