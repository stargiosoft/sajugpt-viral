...
export function BulletRow({ text }: { text: string }) {
  return (
    <div className="flex items-start" style={{ gap: '10px' }}>
      <img
        src="/money-timeline/star-bullet.png"
        alt=""
        style={{
          width: '18px',
          height: '18px',
...
export default function MoneyStyleCard({
  moneyStyle,
  stargioRaw,
}: Props) {
  void stargioRaw;
    ...
    <div style={{ padding: '12px 0 0', textAlign: 'center' }}>
      <p
        style={{
          ...
          marginBottom: '6px',
          padding: '0 20px',
          WebkitTextStroke: '0.3px rgb(13,13,13)',
        }}
      >
        나의 재물 성향은
      </p>
      ...
      <div
        style={{
          borderRadius: '20px',
          backgroundImage:
            'url(/money-timeline/style-panel-pattern-v2.png)',
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: '16px',
            boxShadow: '0 4px 12px rgba(124,92,252,0.10)',
        ...
        >
          ...
          <div
            style={{
              marginBottom: '16px',
              borderTop: '1px dashed rgb(229,227,249)',
            }}
          />

          <BulletRow
            text={`“${moneyStyle.yongsinNote.replace(
              /^다만\s*/,
              ''
            )}”`}
          />
