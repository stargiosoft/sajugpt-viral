...
export default function PressableButton({
  ...
  return (
    <div style={{ position: 'relative', height: '56px', width: '100%', ...style }}>
      <BgTag
        href={href}
        target={target}
        rel={rel}
        ...
        className="transform-gpu w-full h-full flex items-center justify-center relative overflow-hidden"
      ...
      >
        ...
        <p style={{ fontSize: '15px', fontWeight: 600, whiteSpace: 'nowrap', zIndex: 1, ...textStyle }}>
          {label}
        </p>
      </BgTag>
    </div>
