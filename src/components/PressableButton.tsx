...
export default function PressableButton({ label, onClick, disabled, style, bgStyle, textStyle, hoverBackground }: Props) {
  const hoverProps = hoverBackground
    ? { ...PRESS_HOVER_PROPS, whileHover: { ...PRESS_HOVER_PROPS.whileHover, backgroundColor: hoverBackground } }
    : PRESS_HOVER_PROPS;
