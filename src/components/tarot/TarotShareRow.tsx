...
export default function TarotShareRow({
  ...
  const { palette, brushFont } = config.theme;
      ...
      <div className="flex items-center" style={{ gap: 16, marginTop: 18 }}>
        ...
        <GhostIconButton ariaLabel="링크 복사" onClick={handleCopy}>
          {copied ? (
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
              <path d="M9 17H7A5 5 0 0 1 7 7h2M15 7h2a5 5 0 1 1 0 10h-2M8 12h8" stroke={palette.ink} strokeWidth="2" strokeLinecap="round" />
            </svg>
          )}
        </GhostIconButton>
      </div>
