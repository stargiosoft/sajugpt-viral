  ...
  return (
    <div className="flex items-center" style={{ gap: '6px', marginTop: '2px' }}>
      <span className="flex items-center" style={{ gap: '4px' }}>
        <svg width="9" height="9" viewBox="0 0 24 24" fill="#c2c2c6" style={{ display: 'block' }}>
        ...
        <span style={{ fontSize: '11px', fontWeight: 600, color: '#9c9ca2', letterSpacing: '-0.1px', lineHeight: '1', display: 'block' }}>{plays}</span>
      </span>
      <span className="flex items-center" style={{ gap: '4px' }}>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#adadb2" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
        ...
        <span style={{ fontSize: '11px', fontWeight: 600, color: '#9c9ca2', letterSpacing: '-0.1px', lineHeight: '1', display: 'block' }}>{shares}</span>
      </span>
    </div>
  );
}
