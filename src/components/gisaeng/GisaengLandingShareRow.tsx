...
export default function GisaengLandingShareRow({ shareContent }: Props) {
  ...
  return (
    <div className="flex justify-center" style={{ gap: '20px' }}>
      ...
      <ShareIconButton ariaLabel="링크 복사" onClick={copyLink} style={{ ...ICON_STYLE, background: '#B8423A' }} hoverBackground="#9C342E">
